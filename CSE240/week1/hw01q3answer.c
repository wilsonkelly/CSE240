...
#include <stdio.h>
// #pragma warning(disable : 4996) // needed if you use Visual Studio

// CSE 240 Fall 2022 Homework 1 Question 3 (20 points)
...
int main(){
	...
	printf("Error Type: Semantic \n\n");
     ...
     printf("The code is syntactically and contextually correct."+
			"It will compile and run, but the meaning for the user is incorrect.\n\n");
